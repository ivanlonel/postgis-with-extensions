...
NEW_PRELOAD_LIBRARIES="pgaudit,pgauditlogtofile,pglogical,pglogical_ticker,pgmemcache,pg_cron,pg_show_plans,pg_similarity,pg_stat_statements,plprofiler,plugin_debugger,postgis-3,set_user,timescaledb"  # ,pg_partman_bgw
